            ...
            <div class="card card-primary">
                ...
                if ($hari == 'Sunday' || $hari == 'Saturday') : ?>
                    <div class="card-body">
                        ...
                        <a href="<?= base_url('admin/absensi') ?>"><button class="btn btn-primary">Kembali</button></a>
                    </div>
                <?php else : ?>
                    <a href="<?= base_url('admin/absensi') ?>"><button class="btn btn-primary float-right mr-4 mt-3">Kembali</button></a>
                    <form action="" method="POST">
                        <input type="hidden" name="nis" value="<?= $identitas ?>">
